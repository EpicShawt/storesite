...
export const products = [
  {
    ...
    images: [{
      url: "/products/prod1.jpg",
      publicId: "prod1_batman_tshirt",
      cloudinaryUrl: "/products/prod1.jpg"
    }],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [{
      url: "/products/prod2.jpg",
      publicId: "prod2_itachi_tshirt",
      cloudinaryUrl: "/products/prod2.jpg"
    }],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [{
      url: "/products/prod3.jpg",
      publicId: "prod3_trendy_printed_tshirt",
      cloudinaryUrl: "/products/prod3.jpg"
    }],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
    featured: false,
  ...
  },
  {
    ...
    images: [{
      url: "/products/prod4.jpg",
      publicId: "prod4_asur_iconic_tshirt",
      cloudinaryUrl: "/products/prod4.jpg"
    }],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
    featured: true,
  ...
  },
  {
    ...
    images: [{
      url: "/products/prod5.jpg",
      publicId: "prod5_money_tshirt",
      cloudinaryUrl: "/products/prod5.jpg"
    }],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    inStock: true,
    featured: false,
